...
public interface EnderecoRepository extends JpaRepository<Endereco, Integer> {
    ...
    @Query(value = "SELECT * FROM endereco e, usuario_endereco ue WHERE e.id = ue.endereco_id AND ue.usuario_email = ?1", nativeQuery = true)
    public List<Endereco> listarEnderecos(String userId);
}
